...
class AssetDetailsFilled extends StatefulWidget {
  static const routeName = '/asset-details-filled';

  @override
  _AssetDetailsFilledState createState() => _AssetDetailsFilledState();
}

class _AssetDetailsFilledState extends State<AssetDetailsFilled> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: buildAppBar(context, "Asset Information - Filled"),
      drawer: MenuDrawer(),
